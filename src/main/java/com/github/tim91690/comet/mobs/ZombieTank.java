...
public class ZombieTank extends CometMobs {
    int lvl;
    ...
    private float[] getWeightByLevel() {
        float[] weight = switch (this.lvl) {
            default -> new float[]{90, 9, 0.9f, 0.1f};
            case 2 -> new float[]{0.1f, 90, 9, 0.9f};
            case 3 -> new float[]{0.1f, 0.9f, 90, 9};
            case 4,5 -> new float[]{0.1f, 0.9f, 9, 90};
        };
